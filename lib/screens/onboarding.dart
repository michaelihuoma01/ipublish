                                    ...
                                    TextFormFieldWidget(
                                      ...
                                      validator: (String input) {
                                        ...
                                        if (input.split(' ').length < 2)
                                          return 'One more name to go...';
                                        if (input.trim().length < 5)
                                          return 'Are those real names? So short!';
                                      },
                                    )
                                  ],
                                ),
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        Text(
                                            'I agree to all terms and condiions'),
                                      ],
                                    )
                                  ],
                                ),
                            ...
                            : _currentPage == _numPages - 2
                                ...
                                : Row(
                                    ...
                                    children: [
                                      getPlainButton(
                                          _con.pageController, 'Back'),
                                      getButton(_con.pageController, 'Next'),
                                    ],
                                  ),
                  ],
                ),
